  ...
  return (
    <main className="public-alternating-page font-sans overflow-hidden bg-[#030713] text-white">
      ...
      <section className="relative isolate min-h-[calc(100svh-4.5rem)] overflow-hidden bg-[#050817] pt-24 sm:pt-28 lg:pt-24 pb-12">
        ...
        <div className="pointer-events-none absolute right-[8%] top-[14%] -z-10 h-64 w-64 rounded-full bg-white/10 blur-3xl" />
        <div className="pointer-events-none absolute bottom-[16%] left-[6%] -z-10 h-48 w-48 rounded-full bg-white/10 blur-3xl" />

        {/* Text safe backdrop overlays placed behind content at -z-10 */}
        <div className="pointer-events-none absolute inset-0 -z-10 bg-[linear-gradient(to_right,rgba(5,8,23,0.85)_0%,rgba(5,8,23,0.5)_50%,transparent_85%)]" />
        <div className="pointer-events-none absolute inset-x-0 bottom-0 -z-10 h-32 bg-gradient-to-t from-[#050817] to-transparent" />

        <div className="relative z-10 mx-auto flex min-h-[calc(100svh-9.5rem)] w-full max-w-7xl items-center px-5 py-10 sm:px-8 sm:py-12 lg:px-12">
          <div className="max-w-3xl">
            <h1 className="text-2xl font-bold leading-[1.15] tracking-tight text-white sm:text-4xl lg:text-5xl drop-shadow-md">
              {heroTitle}
            </h1>

            <p className="mt-6 max-w-2xl text-base font-normal leading-[1.7] text-white/90 sm:text-lg drop-shadow-sm">
              {heroSubtitle}
            </p>
